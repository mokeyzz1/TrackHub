...
| Identity collisions | School collisions are reduced to two intentional pairs; athlete scan finds 209 shared Athletic.net URLs (151 same-shape, 58 mixed-shape) plus a broad 7,037-group name collision population. | Names/URLs alone are not merge keys. Hold for source-backed evidence and per-group reviewed maps. |
