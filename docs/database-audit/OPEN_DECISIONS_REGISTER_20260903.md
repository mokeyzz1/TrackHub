...
| DB-18 | Access control | Canonical public reads are policy-backed; private ingest uses grants; all historical backup tables are isolated in `archive` and denied to public roles. | Recheck grants and function boundaries after each future schema change. | Verified 2026-09-04; archive boundary complete |
