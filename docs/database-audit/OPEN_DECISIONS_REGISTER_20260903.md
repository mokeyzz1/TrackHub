...
| DB-02 | `Other` division | 129 schools / 245 teams / 5,654 athletes; the first 38 high-impact rows reviewed in `OTHER_DIVISION_RESEARCH_20260904.md` resolve to NCAA Division III, NAIA, and Canadian U SPORTS/OUA programs. | Do not reinterpret `Other`; classify only source-reviewed cohorts. | Decided: no bulk remap; evidence pass in progress |
