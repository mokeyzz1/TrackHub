...
| --- | --- | --- | --- | --- |
| DB-01 | Person vs affiliation | `Unattached` school 1835 contains 48,124 athletes, 56,046 results, and 21 relay parents; `athlete_team_seasons` has zero linked rows. | Add explicit nullable/typed affiliation semantics in parallel; preserve placeholder until deterministic backfill and rollback pass. | Foundation columns applied; dual-read/write rollout held |
