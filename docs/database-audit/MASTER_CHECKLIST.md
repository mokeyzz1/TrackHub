...
Current focus: **ING-04 — consolidate result scraper entrypoints and retire duplicate engines**.
ING-04 is complete in the branch. It is code-only: provider-specific adapters and repair tools are
preserved while one scheduled production coordinator is enforced. No historical results were
changed. Follow the checkpoint IDs below, with the owner's direction controlling
