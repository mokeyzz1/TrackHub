...
| ING-02c | P1 | Model immutable per-run source payloads and explicit source corrections; measure historical ambiguity without fabricating payload versions | MODEL-01, ING-02b | Open; version preservation, direct-writer inventory/guards, and snapshot-backed correction apply workflow complete 2026-09-08; live scan found zero eligible correction quarantines; legacy no-snapshot recovery and 918 historical observation/meet discrepancies remain held |
...
| ING-02h | P1 | Reconcile interrupted-run semantics and historical observed-meet/canonical-meet discrepancies without rewriting evidence | MODEL-01, ING-02g | Open: RUN_RELATIONSHIPS_20260905.md; two stale run candidates and 918 historical observation discrepancies measured, not auto-repaired |
...
| DATA-01-COLLEGIATE-RESULTS | P1 | Repair source-proven competition affiliations for the confirmed collegiate cohort, including 52 Clark/Lane rows already routed to the wrong schools | DATA-01-COLLEGIATE-CATALOG | Partial/applied 2026-09-06: 52 TFRRS-linked 4x100 result legs and their 13 relay parents corrected from Clark (MA)/Lane (TN) to Clark College/Lane Community College across four NWAC meets. Exactly 65 before-images retained; rollback rehearsal passed. The remaining teamless results stay open until result-level evidence is available. |
