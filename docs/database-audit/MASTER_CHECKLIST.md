...
| ING-02c | P1 | Model immutable per-run source payloads and explicit source corrections; measure historical ambiguity without fabricating payload versions | MODEL-01, ING-02b | Open; version preservation, direct-writer inventory/guards, and snapshot-backed correction apply workflow complete 2026-09-08; legacy no-snapshot recovery and 918 historical observation/meet discrepancies remain held |
