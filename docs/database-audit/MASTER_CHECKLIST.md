...
| MIG-01 | P0 | Reconcile local and live migration versions/statements; classify every unmatched entry; prove a safe deployment path without replaying applied SQL | SAFE-01 | Open only for MIG-01e3 hosted-CI confirmation; local/live history is reconciled |
